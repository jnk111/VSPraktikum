...
public final class ExceptionUtils {
	...
	for (int i = 0; i < stackTrace.length; i++) {
		...
		if (skipped > 0) {
		    ...
		    trace.append(String.format(traceElement, i - 1, prev.getClassName(), prev.getMethodName(),
			    prev.getFileName(), prev.getLineNumber()));
		}
		// print current element
		trace.append(String.format(traceElement, i, elem.getClassName(), elem.getMethodName(),
