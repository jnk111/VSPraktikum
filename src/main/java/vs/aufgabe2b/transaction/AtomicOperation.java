...
public class AtomicOperation implements Cloneable {
     ...
     *            Message for this operation.
     */
    AtomicOperation(final Bank bank, final Type type, final String account, final int amount, final String message) {
	...
	try {
	    ...
	    // should never occur
	    throw new TransactionException("Gerriet hat in der Implementierung Mist gebaut!", e);
	}
    }
}
