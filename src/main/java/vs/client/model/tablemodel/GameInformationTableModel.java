package vs.client.model.tablemodel;
...
import vs.client.model.comparator.GameInformationComparator;

@SuppressWarnings("serial")
/**
 * Diese Klasse implementiert ein TableModel um Informationen über laufende Spiele anzuzeigen.
 * @author Jones
 */
public class GameInformationTableModel extends DefaultTableModel {
	...
	/**
	 * Liefert die Anzahl an Einträgen
	 */
    @Override
	...
	/**
	 * Lädt die Tabelle mit neuen Daten.
