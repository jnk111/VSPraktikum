...
public class Event {
	 ...
	 * @param reason Beschreibung des Ausl�sers.
	 * @param ressource die URI der Ressource, die mit diesem Event zusammenh�ngt
	 * @param player Die URI des Spielers der das Event ausgel�st hat.
	 */
