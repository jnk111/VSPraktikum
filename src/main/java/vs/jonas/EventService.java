...
public class EventService {
	...
	private int nextId; // wird hochgez�hlt
	...
	public void startService(){
		...
		post(EVENTS_BASE, (req,res) -> {
			try{
				...
				// Ressource, Player & Time d�rfen leer sein, der Rest nicht.
				...
				System.err.println("Fehler: Der Content im Body der empfangenen Nachricht entspricht nicht dem g�ltigen Format.");
		...
		get(EVENTS_BASE, (req,res) -> {
			...
			System.out.println("Get Events wird ausgef�hrt...");
